...
# Todo next
# 1. Implement regulator
# 2. Validate sign of the force in dynamics
# 3. Implement reference tracking controller
# 4. Try out perturbation method of linearisation
...
def controller(model, data):
    ...
    A,B = optimal_control.linearize_numerical_perturbation(x,u)
    ...
    C = np.eye(4)
    v = optimal_control.tracking_input(A,B,K,C,ja)

    # feedforward term
    ff = optimal_control.feedforward_term(x)
